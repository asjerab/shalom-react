...
export default function AlphakursModal() {
  ...
  return (
    <>
      ...
      {isMobile && (
        <div className={`fixed left-1/2 transform -translate-x-1/2 w-full bottom-0 z-50 bg-[#1a1a1a] rounded-t-[25px] ${ isOpen ? "block" : "hidden" }`} >
          ...
          <p className="primaryFontRegular font-light px-[2em] text-slate-50">
            ...
            holdes hver lørdag over syv uker. Hver kursdag begynner med én time
          ...
          <Link href="/customForm?formId=alphakursYouth">
            <div className="p-[2em]">
      ...
      {!isMobile && (
        <div className={`modal-container modal-container fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[900px] max-w-full m-[auto 0] z-50 ${ isOpen ? "block" : "hidden" }`} >
        <div className="modal-content modal-content bg-[#1a1a1a] rounded-[25px] p-[3em] m-[1em]">
          ...
          <div className="py-5">
            <Link
              target="_blank"
              href="/customForm?formId=alphakursYouth"
            >
