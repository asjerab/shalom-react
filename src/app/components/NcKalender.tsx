...
const data = [
    ...
    { month: "February", id: "/event/KalenderNewCreation/Bonnemote", date: 6, image: 'grupperImages/bonnBilde.png'},
    { month: "February", id: "/event/KalenderNewCreation/Daap", date: 8, image: 'grupperImages/daapBilde.png'},
    ...
    { month: "May", id: "/event/arrangementNewCreation/LovsangsKveld", date: 18, image: 'arrangementImages/LovsangskveldImg.png'},
...
const Home: React.FC = () => {
  ...
  return (
    <main className="py-[100px] px-[20px]">
      <div className="w-full max-w-[1000px] mx-auto p-4 kalender-div" id="NewCreation-kalender">
        <div>
          <h1
          ...
          >
            Dette er Shalom youth sin helt egne kalender. Her kan du se hva
