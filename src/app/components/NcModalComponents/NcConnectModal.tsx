      ...
      {isMobile && (
        ...
        >
          ...
          <p className="primaryFontRegular font-light px-[2em] text-slate-50">
            Connect er småfellesskapsarbeidet vi har i fellesskapet. På søndager
        ...
        >
          <div className="modal-content modal-content bg-[#1a1a1a] rounded-[25px] p-[3em] m-[1em]">
            ...
            <p className="primaryFontRegular text-slate-50 py-5 text-[17px] modal-p">
              ...
              søndager møtes vi i storfellesskapet, mens i Connect møtes vi i
            ...
            <div className="py-5">
              <Link
                target="_blank"
                href="/NcCustomForm?formId=connectNewCreation"
              >
