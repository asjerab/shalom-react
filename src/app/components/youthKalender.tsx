...
const data = [
  ...
  { month: "May", id: "/event/kalenderYouth/Gudstjeneste", date: 10, image: 'arrangementImages/gudstjenesteBilde.png'},
  ...
  { month: "May", id: "/event/arrangement/LovsangsKveld", date: 18, image: 'arrangementImages/LovsangskveldImg.png'},
...
const Home: React.FC = () => {
  return (
    <main className="py-[100px] px-[20px]">
      <div className="w-full max-w-[1000px] mx-auto p-4 kalender-div " id="youth-kalender">
        <div>
          <h1
